...
public class Graph_view extends Frame implements ActionListener,WindowListener{
	...
	public Graph_view(){
		...
		JFreeChart chart = 
				   ChartFactory.createBarChart("Import Volume","Year","Ton",data,PlotOrientation.HORIZONTAL,true,false,false);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==button1){
			...
			JFreeChart chart = 
					   ChartFactory.createLineChart("Import Volume","Year","Ton",data,PlotOrientation.HORIZONTAL,true,false,false);
